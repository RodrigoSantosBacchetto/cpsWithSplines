/**
 * @file        InnerDistanceL2.hpp
 *
 * @brief       Defines a L2 distance functor template class.
 *
...
#ifndef CVX_METRIC_INNER_DISTANCE_L2_HPP__INCLUDED
#define CVX_METRIC_INNER_DISTANCE_L2_HPP__INCLUDED
...
namespace cvx {
    ...
    /**
     * @brief      The inner-euclidean distance functor.
     */
    typedef DistanceConnective_< NormL2, ConnectorL2 >
                InnerDistanceL2,
                InnerDistanceEuclidean;

}


#endif // CVX_METRIC_INNER_DISTANCE_L2_HPP__INCLUDED
