...
#ifndef CVX_METRIC_DISTANCE_L2_HPP__INCLUDED
#define CVX_METRIC_DISTANCE_L2_HPP__INCLUDED
...
namespace cvx {
    ...
    /**
     * @brief      Aliases for L2-norm based distance functors.
     */
    typedef Distance_< NormL2 > DistanceL2,
                                DistanceEuclidean;

}


#endif // CVX_METRIC_DISTANCE_L2_HPP__INCLUDED
